...
<table class="table table-bordered table-hover dataTable no-footer" id="sample_1" role="grid" aria-describedby="sample_1_info">
							...
							<th class="sorting_asc" tabindex="0" aria-controls="sample_1" rowspan="1" colspan="1" style="width: 177px;" aria-sort="ascending" aria-label="
									 Username
								: activate to sort column ascending">
									 Student Name
								</th><th class="sorting_disabled" rowspan="1" colspan="1" style="width: 301px;" aria-label="
									 Email
								">
									 Scholler No.
								</th><th class="sorting_disabled" rowspan="1" colspan="1" style="width: 163px;" aria-label="
									 Status
								">
									 Action
								</th></tr>
