...
$sql="insert into news(title,description,date,user_id,category_id,curent_date,role_id)values('$news_title','$news_details','$news_date','$user_id','$category_id','$curent_date','$role_id')";
$r=mysql_query($sql);
