		 ...
		 <div class="page-content">
			<div class="portlet box blue">
				<div class="portlet-title">
					<div class="caption">
						<i class="fa fa-gift"></i> View Faculty
					</div>
				<div class="tools">
					<a class="" href="create_user.php" style="color:white"><i class="fa fa-plus">&nbsp;Add Faculty</i></a>
					</div>
				</div>
...
$(document).ready(function(){    
	$(".view_u").die().live("click",function(){
			...
			$.ajax({
				url: "ajax_view_users.php?view_u="+view_u+"&to="+to+"&from="+from,
