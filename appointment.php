			...
			<div class="portlet box">
						...
						<div class="portlet-body form">
                              ...
                              <div style="margin:10px">
                             	...
                             	<a href="appointment.php?s=0" class="<?php if($status_ftc==0){ echo 'btn btn-sm green'; } else { echo 'btn btn-sm blue'; }  ?>">In-Process <i class="glyphicon glyphicon-refresh"></i></a>
                                <a href="appointment.php?s=1" class="<?php if($status_ftc==1){echo 'btn btn-sm green'; } else { echo 'btn btn-sm blue'; }  ?>">Approved <i class="glyphicon glyphicon-ok"></i></a>
                                <a href="appointment.php?s=2" class="<?php if($status_ftc==2){echo 'btn btn-sm green'; } else { echo 'btn btn-sm blue'; }  ?>">Rejected <i class="glyphicon glyphicon-remove"></i></a>
                                <a href="appointment.php?s=3" class="<?php if($status_ftc==3){echo 'btn btn-sm green'; } else { echo 'btn btn-sm blue'; }  ?>">Completed <i class="glyphicon glyphicon-check"></i></a>
                              </div>
