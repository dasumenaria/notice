		 ...
		 <div class="page-content">
			...
			<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Banned View
							</div>
							<div class="tools">
...
$(document).ready(function() {
	...
	$(".user1").live("change",function()
	{
		...
		$("#data").html('<span class="loading_span" align="center">Loading...</span>');
 		$.ajax({
		url: "ajax_ban_view.php?pon1="+s+"&pon2="+t+"&pon="+c,
		}).done(function(response)
		{
			$("#data").html(""+response+"");
		});
	...
	{	
		...
		$.ajax({
		url: "ajax_ban_view.php?pon="+t+"&pon1="+s+"&pon2="+sb+"&dt="+d,
		}).done(function(response)
		{
			$("#data").html(""+response+"");
		});
