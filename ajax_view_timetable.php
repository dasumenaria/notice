...
{
		$sd=mysql_query("update `time_table` SET `flag`='1' where id='$syllabus_delete'" );
		$sql=mysql_query($sd);
}
		?>
		<div><table class="table-condensed table-bordered" width="100%">
							  ...
							  <?php
			  $r1=mysql_query("select * from time_table where flag='0' AND class_id='".$view_u."' order by id Desc");		
					$i=0;
				...
				$subject=mysql_query("select * from master_section where id='".$section_id."'");		
					...
					?>
							...
							<?php echo $i;?>
									...
									<td>
                                       <a class="btn btn-circle btn-xs" style="color:#03F; background-color:#EEEEEE" href="edit_timetable.php?id=<?php echo $id;?>" style="color: white">
